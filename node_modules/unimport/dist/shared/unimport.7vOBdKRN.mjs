import { V as VUE_TEMPLATE_NAME, a as vueTemplateAddon, u as VUE_DIRECTIVES_NAME, v as vueDirectivesAddon, n as getMagicString, b as stripCommentsAndStrings, m as matchRE, e as excludeRE, s as separatorRE, i as importAsRE, d as defineUnimportPreset, t as toExports, p as normalizeImports, f as dedupeImports, g as stripFileExtension, j as toTypeDeclarationFile, k as toTypeReExports, o as addImportToCode } from './unimport.COUA4LL_.mjs';
...
async function scanFilesFromDir(dir, options) {
  ...
  const indexOfDirs = (file) => dirGlobs.findIndex((glob) => pm.isMatch(file, glob));
